...
export const TOURS = [
  ...
  { id: 'scenarios', title: 'Scenarios', promise: 'Run a relay test recipe and read the matrix.', steps: [
    ...
    { target: '[data-action="scenario-new"], .slist', title: 'Make your own', text: '<b>New Scenario…</b> starts from a recipe: a note, a replaceable event, an ephemeral one, a sealed message, a group. Change what you like, or press <b>Record</b> and publish from the terminal. Any event\'s ··· menu has <b>Add to Scenario…</b> too.', placement: 'right' },
...
export const TIPS = {
  ...
  editor: { title: 'Scenario editor', text: 'Who signs, then steps. Each step publishes one event and says what every relay should do with it. Start from a recipe, record what you publish, or write the JSON.', tour: 'editor', step: 0 },
